...
const Header = () => {
  ...
  return (
    <div className={`w-full h-[200px] bg-[transparent] flex flex-col items-center justify-center rounded-2xl mb-8 text-white [color:${getTextColor(location.pathname)}] [display:${visibleHeader(location.pathname)}]`}>
